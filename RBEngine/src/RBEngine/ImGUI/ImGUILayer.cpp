...
namespace RB
{
	...
	void ImGUILayer::UseDarknessTheme()
	{
		...
		colors[ImGuiCol_MenuBarBg] = ImVec4(0.046f, 0.046f, 0.046f, 1.00f);
		...
		colors[ImGuiCol_Header] = ImVec4(0.25f, 0.25f, 0.25f, 0.9f);
